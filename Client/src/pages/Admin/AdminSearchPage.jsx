  ...
  return (
    <>
      ...
      >
        <DialogTitle
          sx={{ m: 0, p: 2 }}
          style={{ fontSize: '30px', fontFamily: 'Manrope', fontWeight: 'bold', marginTop: '20px' }}
        ...
        <DialogContent
          dividers
          sx={{ display: 'flex', flexDirection: 'column', gap: 3, marginTop: '20px' }}
        >
          <TextField
            id="outlined-basic"
            ...
            sx={{ width: '60%', marginLeft: 'auto', marginRight: 'auto', marginTop: '30px' }}
