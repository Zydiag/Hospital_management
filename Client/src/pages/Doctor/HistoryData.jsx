...
const HistoryData = () => {
  ...
  const rowsPMH = [
    ...
    { personnelInfo: 'Description', data: 'Patient exhibits high blood pressure and elevated blood sugar levels.' },
    { personnelInfo: 'Known Allergies', data: 'Penicillin, Peanuts' },
    { personnelInfo: 'Miscellaneous', data: 'Patient follows a low-carb diet and exercises regularly.' },
  ...
  return (
    ...
    <Navbar />
      ...
      <center>
      <Button className="print" variant='outlined' onClick={handlePrint}>Print</Button>
      </center>
